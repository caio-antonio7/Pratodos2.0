...
class CardapioReceitas : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun abrirBoloDeChocolate() {
            val intent = Intent(
                this, BoloDeChocolate::class.java
            )
            startActivity(intent)
        }
        ...
        fun abrirBoloDeBanana() {
            val intent = Intent(
                this, BoloDeBanana::class.java
            )
            startActivity(intent)
        }
    }

    private fun abrirBoloDeBanana() {
        TODO("Not yet implemented")
    }

    private fun abrirBoloDeChocolate() {
        TODO("Not yet implemented")
    }

    private fun abrirPaoDeQueijo() {
        TODO("Not yet implemented")
    }
}